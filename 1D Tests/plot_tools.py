...
def plot_sloshy(t, theta, theta_d, u, umotor, max_accel, Omega, vel, acc, err, errdot, ecumul):  
    ...
    Args:
        ...
        Omega (float): return value from the motor controller of the actual speed of the motor using it's Hall sensor
        vel (float): calculated angular velocity using numerical differentiation of theta
        acc (float): calculated angular acceleration using numerical differentiation of theta
